	...
	class Exopite_Simple_Options_Framework_Field_typography extends Exopite_Simple_Options_Framework_Fields {
		...
		public function output() {
			...
			if ( is_object( $google_json ) ) {
				...
				echo '<optgroup label="' . esc_attr__( 'Web Safe Fonts', 'changenowio' ) . '">';
				...
				echo '<optgroup label="' . esc_attr__( 'Google Fonts', 'changenowio' ) . '">';
				...
				echo esc_attr__( 'Error! Can not load json file.', 'changenowio' );
			}
